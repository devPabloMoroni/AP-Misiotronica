    ...
    <footer class="footer mt-auto py-3 bg-light">
      ...
      <div class="row justify-content-around">
        ...
        <div class="col-2">
          <div class="row justify-content-around">
            <div class="col-3">
              <a class="text-muted" target="_blank" rel="noreferrer" href="https://www.facebook.com">
            ...
            <div class="col-3">
              <a class="text-muted" target="_blank" rel="noreferrer" href="https://www.instagram.com">
                <svg width="25" height="25" fill="currentColor" viewBox="0 0 16 16">
            ...
            <div class="col-3">
              <a class="text-muted" target="_blank" rel="noreferrer" href="https://www.twitter.com">
                <svg width="25" height="25" fill="currentColor" viewBox="0 0 16 16">
